...
class CircleElement extends AbstractHTMLElement
{
    const ELEMENT_TYPE = 'circle';
//    private $physattr;
...
//        $Head->writeScript(__DIR__ . '/assets/circle.js');
        $Head->writeStyleSheet(__DIR__ . '/assets/circle.css');
    }
